...
class CornersProblem(search.SearchProblem):
	...
	for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
		x,y = state[0]
			...
			passedCorner = list(state[1])
			if nextStatePosition in self.corners and (nextStatePosition not in passedCorner): 
				passedCorner.append(nextStatePosition)
                        successors.append(((nextStatePosition, passedCorner), action, 1))
